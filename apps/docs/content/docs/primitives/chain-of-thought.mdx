...
import { ChainOfThoughtPrimitiveSample as ChainOfThoughtPrimitiveSampleBase } from "@/components/docs/samples/chain-of-thought-primitive.base";
...
<Tabs items={["Preview", "Code"]}>
  <Tab>
    <Flavored
      base={<ChainOfThoughtPrimitiveSampleBase />}
      radix={<ChainOfThoughtPrimitiveSample />}
    />
  </Tab>
  <Tab>
```tsx
