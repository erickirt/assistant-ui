...
import * as AttachmentBaseSamples from "@/components/docs/samples/attachment.base";
import { Flavored, FlavorSwitcher } from "@/components/docs/contexts/flavor.server";

<FlavorSwitcher />

<Flavored radix={<AttachmentSample />} base={<AttachmentBaseSamples.AttachmentSample />} />
