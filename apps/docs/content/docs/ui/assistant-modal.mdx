...
import * as AssistantModalBaseSamples from "@/components/docs/samples/assistant-modal.base";
...
<Flavored radix={<AssistantModalSample />} base={<AssistantModalBaseSamples.AssistantModalSample />} />
