...
import * as ModelSelectorBaseSamples from "@/components/docs/samples/model-selector.base";
...
<Flavored radix={<ModelSelectorSample />} base={<ModelSelectorBaseSamples.ModelSelectorSample />} />
