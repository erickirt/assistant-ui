...
import * as TabsBaseSamples from "@/components/docs/samples/tabs.base";
...
<Flavored radix={<TabsSample />} base={<TabsBaseSamples.TabsSample />} />
...
<Flavored radix={<TabsVariantsSample />} base={<TabsBaseSamples.TabsVariantsSample />} />
...
<Flavored radix={<TabsSizesSample />} base={<TabsBaseSamples.TabsSizesSample />} />
...
<PreviewCode file="components/docs/samples/tabs" name="TabsWithIconsSample" base={<TabsBaseSamples.TabsWithIconsSample />}>
  <TabsWithIconsSample />
</PreviewCode>
...
<PreviewCode file="components/docs/samples/tabs" name="TabsControlledSample" base={<TabsBaseSamples.TabsControlledSample />}>
  <TabsControlledSample />
</PreviewCode>
...
<PreviewCode file="components/docs/samples/tabs" name="TabsAnimatedIndicatorSample" base={<TabsBaseSamples.TabsAnimatedIndicatorSample />}>
  <TabsAnimatedIndicatorSample />
</PreviewCode>
